...
<template>
  ...
  >
    ...
    <div>
      <el-text class="mx-1" type="danger">请勿泄露您的消息密钥，否则可能会出现安全问题！切勿在公共群聊长时间打开本功能！</el-text>
      <strong>本功能仅提供学习与交流，禁止非法传播！①禁止将本功能适用于违法场合;②禁止将本功能引入任何闭源项目;如有出现，将纠者责任底！</strong>
    </div>
